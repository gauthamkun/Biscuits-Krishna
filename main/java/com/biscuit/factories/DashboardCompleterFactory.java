...
public class DashboardCompleterFactory {
	...
	public static List<Completer> getDashboardCompleters() {
		...
		completers.add(new ArgumentCompleter(new StringsCompleter("go_to"),
				new StringsCompleter("project"), new StringsCompleter(getProjectsNames()),
				new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("go_to"),
				new StringsCompleter(getProjectsNames()), new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("add", "edit", "remove"),
				new StringsCompleter("project"), new NullCompleter()));
